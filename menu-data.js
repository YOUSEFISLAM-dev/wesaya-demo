    ...
    categories: [
        {
            ...
            items: [
                ...
                { name: 'سويت كورن 4 قطع', price: '30.00', img: '', desc: 'ذرة حلوة 4 قطع' }
            ]
        },
        {
            id: 'offers',
            ...
            items: [
                ...
                { name: 'عرض الكومبو', price: '130.00', img: '', desc: 'ساندويتش و فرايز و مشروب' },
                ...
                { name: 'عرض ال15 أستربس', price: '380.00', img: '', desc: '15 استربس + 3 عيش' },
                ...
                { name: 'سوبر سناك', price: '120.00', img: '', desc: 'اثنين قطع دجاج+بطاطس وسط+ارز وسط+عيش' }
            ]
        },
        {
            id: 'drinks',
            ...
            icon: 'fa-glass-water',
            items: [
                { name: 'مشروب غازي ماكينة', price: '25.00', img: '', desc: '' },
                { name: 'لتر مشروب غازي', price: '45.00', img: '', desc: '' },
                { name: 'زجاجة مياه', price: '10.00', img: '', desc: '' },
